<modal idmodal="modal-edit" titulo="Editar usuário" xmlns:v-bind="http://www.w3.org/1999/xhtml">
	<formulario id="form-edit" css="" v-bind:acao="'/admin/usuarios/' + $store.state.item.id" metodo="put" anexo="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="checkbox" id="autor" name="autor" v-bind:checked="$store.state.item.autor == 'S'">
		</div>
	</formulario>
