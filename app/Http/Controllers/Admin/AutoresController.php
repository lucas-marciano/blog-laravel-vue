...
class AutoresController extends Controller
{
    ...
    public function index()
    {
        ...
        $lista = User::select('id', 'name', 'email')->where('autor', 'S')->paginate(15);
        return view('admin.autores.index', compact('breadcrumbs', 'lista'));
    }
    ...
    public function store(Request $request)
    {
        ...
        User::create($data);
        toast()->success("Autor criado com sucesso.", "Parabéns");
